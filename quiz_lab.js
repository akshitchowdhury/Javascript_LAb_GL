function Question(questionText){
  ...
  let q1 = new Question("Q1. Javascript supports which of the following?");
  let q2 = new Question("Q2. Which language is used for styling web pages?");
  let q3 = new Question("Q3. Which is not a JS framework?");
  let q4 = new Question("Q5. Which is used for Connect To Database?");
  let q5 = new Question("Q6. JavaScript is a _____ ?");
  ...
  function Quiz(qaPairArray){
    ...
    this.displayFinalScorePage = function(){
      ...
      `<h1>Result</h1>
      <p id='final_result'>You scored <b>${scores}</b> marks out of 5.\n Your percentage is <b>${percentage}%</b> !!
      `;
